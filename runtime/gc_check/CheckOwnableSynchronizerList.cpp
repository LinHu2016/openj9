...
GC_CheckOwnableSynchronizerList::check()
{
	...
	MM_OwnableSynchronizerObjectList *ownableSynchronizerObjectList = _extensions->getOwnableSynchronizerObjectListExternal();
	...
	j9tty_printf(PORTLIB, "  <gc check: OwnableSynchronizerList OwnableSynchronizers=%zu >\n", ownableSynchronizerCount);
}

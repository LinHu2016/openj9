...
/* End of options relating to dynamicBreadthFirstScanOrdering */
		...
		if (try_scan(&scan_start, "disableRecliamCodeCacheOnLocalGC")) {
			extensions->disableRecliamCodeCacheOnLocalGC = true;
			vm->runtimeFlags |= J9_RUNTIME_NORECLIAMCODECACHEONLOCALGC;
			continue;
		}

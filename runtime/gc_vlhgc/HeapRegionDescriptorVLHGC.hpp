...
//		MM_HeapRegionDescriptorVLHGC *_nextRegion4LargestFreeMemory;  /**< Region list link for compact group resource management during a copyforward operation */
//		MM_HeapRegionDescriptorVLHGC *_previousRegion4LargestFreeMemory;  /**< Region list link for compact group resource management during a copyforward operation */
	} _copyForwardData;

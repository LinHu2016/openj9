...
{
	MM_MemoryPoolAddressOrderedList *memoryPool = (MM_MemoryPoolAddressOrderedList*)getMemoryPool();
	UDATA regionSize = _extensions->regionSize;
	UDATA consumedBytes = regionSize - memoryPool->getFreeMemoryAndDarkMatterBytes();

...
#ifndef OWNABLESYNCHRONIZEROBJECTLISTONTHEFLY_HPP_
#define OWNABLESYNCHRONIZEROBJECTLISTONTHEFLY_HPP_
 ...
 */
class MM_OwnableSynchronizerObjectListOnTheFly : public MM_BaseNonVirtual
{
/* data members */
private:
	bool				_needRefresh;
...
public:
	...
	static MM_OwnableSynchronizerObjectListOnTheFly* newInstance(MM_EnvironmentBase *env, MM_GCExtensions* extensions);
	 ...
	 */
	MM_OwnableSynchronizerObjectListOnTheFly(MM_GCExtensions* extensions)
		: MM_BaseNonVirtual()
		, _needRefresh(true)
		, _head(NULL)
		, _javaVM(NULL)
...
#endif /* OWNABLESYNCHRONIZEROBJECTLISTONTHEFLY_HPP_ */

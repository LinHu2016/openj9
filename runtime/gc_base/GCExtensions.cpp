...
MM_GCExtensions::getOwnableSynchronizerObjectListOnTheFlyExternal()
{
	Assert_MM_true(!isConcurrentScavengerInProgress());
	ownableSynchronizerObjectListOnTheFly->reset();
	return ownableSynchronizerObjectListOnTheFly;

 ...
 */
	static VMINLINE bool
	tryWinningConcurrentGCScan(volatile ContinuationState *continuationStatePtr, bool isGlobalGC, bool beingMounted)
	{
		do {
	 ...
	 */
	static VMINLINE void
	exitConcurrentGCScan(volatile ContinuationState *continuationStatePtr, bool isGlobalGC)
	{
	...
	{
#if JAVA_SPEC_VERSION >= 19
		ContinuationState *continuationStatePtr = getContinuationStateAddress(vmThread, continuationObject);

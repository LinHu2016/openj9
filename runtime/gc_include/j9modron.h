...
#define J9_GC_MANAGEMENT_POOL_BASE					0x8
#define J9_GC_MANAGEMENT_POOL_JAVAHEAP				J9_GC_MANAGEMENT_POOL_BASE						/* 0x8		*/
#define J9_GC_MANAGEMENT_POOL_TENURED 				(J9_GC_MANAGEMENT_POOL_JAVAHEAP << 1)			/* 0x10		*/
#define J9_GC_MANAGEMENT_POOL_TENURED_SOA 			(J9_GC_MANAGEMENT_POOL_TENURED << 1)			/* 0x20		*/
#define J9_GC_MANAGEMENT_POOL_TENURED_LOA 			(J9_GC_MANAGEMENT_POOL_TENURED_SOA << 1)		/* 0x40		*/
#define J9_GC_MANAGEMENT_POOL_NURSERY_ALLOCATE		(J9_GC_MANAGEMENT_POOL_TENURED_LOA << 1)		/* 0x80		*/
#define J9_GC_MANAGEMENT_POOL_NURSERY_SURVIVOR		(J9_GC_MANAGEMENT_POOL_NURSERY_ALLOCATE << 1)	/* 0x100	*/
#define J9_GC_MANAGEMENT_POOL_REGION_OLD 			(J9_GC_MANAGEMENT_POOL_NURSERY_SURVIVOR << 1)	/* 0x200	*/
#define J9_GC_MANAGEMENT_POOL_REGION_EDEN 			(J9_GC_MANAGEMENT_POOL_REGION_OLD << 1)			/* 0x400	*/
#define J9_GC_MANAGEMENT_POOL_REGION_SURVIVOR 		(J9_GC_MANAGEMENT_POOL_REGION_EDEN << 1)		/* 0x800	*/
#define J9_GC_MANAGEMENT_POOL_REGION_RESERVED 		(J9_GC_MANAGEMENT_POOL_REGION_SURVIVOR << 1)	/* 0x1000	*/

...
//	J9IndexableObject *arrayObject = (J9IndexableObject *)J9_JNI_UNWRAP_REFERENCE(array);
	...
	if (shouldCopy) {
		...
		if (_extensions->debugJniGetPrimitiveArrayCritical || (!_extensions->isAddressWithinHeap(arrayObject)) || ((((UDATA)arrayObject + 0x10) != (UDATA) data) && (((UDATA)arrayObject + 0x8) != (UDATA) data))) {
